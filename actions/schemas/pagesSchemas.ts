...
export const createPageInputSchema = z.object({
  title: z
    ...
    .default("Untitled"),
  description: z.string().max(1000, "Description too long").default(""),
  parent_id: z.uuid("Invalid parent ID").nullable().default(null),
  is_folder: z.boolean().default(false),
});
