        ...
        {showToolbar && (
          ...
          >
            <div className="flex items-center flex-wrap gap-2">
              ...
              <div className="flex items-center space-x-1 border-r pr-4">
                <button onClick={() => insertElement("p")} className="p-2 rounded hover:bg-accent" title="Paragraph">
                  P
                </button>
                <button onClick={() => insertElement("h1")} className="p-2 rounded hover:bg-accent" title="Heading 1">
                  <Heading1 className="w-4 h-4" />
                </button>
                <button onClick={() => insertElement("h2")} className="p-2 rounded hover:bg-accent" title="Heading 2">
                  <Heading2 className="w-4 h-4" />
                </button>
                <button onClick={() => insertElement("h3")} className="p-2 rounded hover:bg-accent" title="Heading 3">
                  <Heading3 className="w-4 h-4" />
                </button>
              </div>

              <div className="flex items-center space-x-1 border-r pr-4">
                <button onClick={() => formatText("insertUnorderedList")} className="p-2 rounded hover:bg-accent" title="Bullet List">
                  <List className="w-4 h-4" />
                </button>
                <button onClick={() => formatText("insertOrderedList")} className="p-2 rounded hover:bg-accent" title="Numbered List">
                  <ListOrdered className="w-4 h-4" />
                </button>
                <button onClick={() => insertElement("blockquote")} className="p-2 rounded hover:bg-accent" title="Quote">
                  <Quote className="w-4 h-4" />
                </button>
                <button onClick={() => insertElement("code")} className="p-2 rounded hover:bg-accent" title="Code">
                  <Code className="w-4 h-4" />
                </button>
              </div>

              <div className="relative">
                <button onClick={() => setShowColorPicker(!showColorPicker)} className="p-2 rounded hover:bg-accent" title="Text Color">
