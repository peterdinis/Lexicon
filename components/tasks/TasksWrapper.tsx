...
const TasksWrapper: FC = () => {
	...
	const onDragStart =
		(colId: string, itemId: string) => (e: React.DragEvent) => {
	...
	const onDropOnItem =
		(targetColId: string, targetItemId: string) => (e: React.DragEvent) => {
			e.preventDefault();
		...
		<DashboardLayout>
			<header className="mb-6">
				...
				<p className="text-sm text-muted-foreground mt-1">
					Drag tasks between columns. Presence is mocked across tabs.
				</p>
			</header>
