...
const TemplatesWrapper: FC = () => {
    ...
    return (
        ...
        <h1 className="text-2xl font-semibold flex items-center gap-2" >
            ...
            < p className = "text-sm text-muted-foreground mt-1" > Pick a template to get started quickly.</p>
                </header>
                ...
                < section className = "animate-fade-in" >
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3" >
                    {
                        ...
                        < div className = "mt-4" >
                        <Button size="sm" variant = "outline" onClick = {() => useTemplate(t.title)}> Use template </Button>
                            </div>
                            </CardContent>
                            </Card>
          ))}
