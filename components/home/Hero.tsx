        ...
        <div className="min-h-full flex flex-col dark:bg-[#1f1f1f]">
            ...
            >
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-sm text-gray-500">Keep all your projects and notes in one place.</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                    <Check className="w-6 h-6 text-emerald-500" />
                    <p className="font-medium">Real-time Collaboration</p>
                    <p className="text-sm text-gray-500">Work together with your team seamlessly.</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                    <Check className="w-6 h-6 text-emerald-500" />
                    <p className="font-medium">Smart Organization</p>
                    <p className="text-sm text-gray-500">Organize ideas, tasks, and notes efficiently.</p>
                </div>
            </motion.div>
