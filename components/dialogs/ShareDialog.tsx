    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Share this page with others or create a public link</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Button onClick={handleShareWithEmail} disabled={loading || !email} className="w-full">
              Share
            </Button>
          </div>
          ...
          <div className="space-y-2">
            ...
            {publicShare ? (
              <div className="flex items-center gap-2 rounded-md border p-2">
                ...
                <span className="flex-1 truncate text-sm">Anyone with the link can view</span>
                <Button
                  variant="ghost"
                  size="sm"
