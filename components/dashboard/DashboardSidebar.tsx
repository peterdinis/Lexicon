        ...
        {!collapsed && expandedSections.workspaces && (
          ...
          >
            {workspaces === undefined ? (
              <LoadingState message="Loading workspaces..." collapsed={collapsed} />
            ) : workspacesCount === 0 ? (
              <EmptyState message="No workspaces yet" icon={Database} collapsed={collapsed} />
            ) : (
              <div
                ref={workspacesRef}
    ...
    <div className="space-y-1">
      ...
      <AnimatePresence>
        {!collapsed && expandedSections.pages && (
          ...
          >
            {pages === undefined ? (
              <LoadingState message="Loading pages..." collapsed={collapsed} />
            ) : pagesCount === 0 ? (
              <EmptyState message="No pages yet" icon={FileStack} collapsed={collapsed} />
            ) : (
              <div
                ref={pagesRef}
                className="max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent"
    ...
    <div className="space-y-1">
      ...
      <AnimatePresence>
        {!collapsed && expandedSections.templates && (
          ...
          >
            {templates === undefined ? (
              <LoadingState message="Loading templates..." collapsed={collapsed} />
            ) : templatesCount === 0 ? (
              <EmptyState message="No templates yet" icon={Sparkles} collapsed={collapsed} />
            ) : (
              <div
                ref={templatesRef}
                className="max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent"
...
const DashboardSidebar: FC = () => {
  ...
  const handleOpenModal = useCallback((modal: any) => {
    setOpenModal(modal);
  }, [setOpenModal]);
